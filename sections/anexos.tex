...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/vista_ejecutiva.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/puntajes_interuniv.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/generador_pdf.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/database1.png}

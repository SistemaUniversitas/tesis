\begin{filecontents}[overwrite]{referencias.bib}
	...
	@techreport{icfes2019inse,
		author       = {{Instituto Colombiano para la Evaluación de la Educación (ICFES)}},
		title        = {¿Cómo se construye el Índice de Nivel Socioeconómico (INSE) en el contexto de las pruebas Saber?},
		type         = {Boletín},
		series       = {Saber al Detalle},
		number       = {4},
		institution  = {ICFES},
		address      = {Bogotá, D.C., Colombia},
		month        = apr,
...
\begin{document} 
	...
	\input{sections/antecedentes.tex}
	\newpage
	...
	\section{METODOLOGÍA}
	%Package array Warning: Column P is already defined on input line 36.

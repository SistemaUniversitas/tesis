...
J. Gómez Restrepo and S. Giraldo Duque
}

\newcommand{\titulo}{Desarrollo de un sistema de información para el análisis comparativo y predictivo de la evolución de competencias académicas entre las pruebas Saber 11 y Saber Pro - Caso Universidad San Buenaventura
}

\newcommand{\tituloencabezado}{Desarrollo de un sistema de información para el análisis comparativo y predictivo de la evolución de competencias académicas entre las pruebas Saber 11 y Saber Pro - Caso Universidad San Buenaventura}
